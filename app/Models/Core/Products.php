...
class Products extends Model
{
	...
	public function paginator($request){
        ...
        'categories_description.categories_name','users.first_name','users.last_name')
  ...
  public function insert($request){
    ...
    foreach($languages as $languages_data){
		...
		$products_listofingredients = 'products_listofingredients_'.$languages_data->languages_id;
		$products_howtoprepare = 'products_howtoprepare_'.$languages_data->languages_id;
        //left banner
        ...
        $req_products_description = $request->$products_description;
		 $req_products_listofingredients = $request->$products_listofingredients;
        ...
        DB::table('products_description')->insert([
			...
			'products_listofingredients' => addslashes($req_products_listofingredients),
			'products_howtoprepare' => addslashes($req_products_howtoprepare)
        ]);
    }
    ...
    foreach($result['languages'] as $languages_data){
      $description = DB::table('products_description')
        ...
        if(count($description)>0){
			...
			$description_data[$languages_data->languages_id]['products_listofingredients'] = $description[0]->products_listofingredients;
			$description_data[$languages_data->languages_id]['products_howtoprepare'] = $description[0]->products_howtoprepare;
			...
			$description_data[$languages_data->languages_id]['products_listofingredients'] = '';
			$description_data[$languages_data->languages_id]['products_howtoprepare'] = '';
