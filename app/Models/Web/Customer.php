...
class Customer extends Model
{
    ...
    public function updateMyProfile($request)
    {
		...
		$customers_speciality = $request->customers_speciality;
		$customers_locality = $request->customers_locality;
		$customers_district = $request->customers_district;
		$customers_pincode = $request->customers_pincode;
		$customers_biodata = $request->customers_biodata;
        ...
        $extensions = array('gif', 'jpg', 'jpeg', 'png');
        if ($request->hasFile('wallimage') and in_array($request->wallimage->extension(), $extensions)) {
            $image = $request->wallimage;
            $fileName = time() . '.' . $image->getClientOriginalName();
            $image->move('resources/assets/images/user_profile/', $fileName);
            $customers_wallimage = 'resources/assets/images/user_profile/' . $fileName;
        } else {
            $customers_wallimage = $request->customers_old_wallimage;
        }
        ...
        $customer_data = array(
			...
			'speciality' => $customers_speciality,
			'locality' => $customers_locality,
			'district' => $customers_district,
			'pincode' => $customers_pincode,
			'biodata' => $customers_biodata,
			
            'gender' => $customers_gender,
            'dob' => $customers_dob,
            'avatar' => $customers_picture,
			'wallimage' => $customers_wallimage,
