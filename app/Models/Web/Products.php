...
public function insert($request){
 ...
 foreach($request->categories as $categories){
	...
	{
		$items = DB::table('manufacturers')
            
            ->leftJoin('manufacturers_info', 'manufacturers_info.manufacturers_id', '=', 'manufacturers.manufacturers_id')
            ->select('manufacturers.manufacturers_id','manufacturers.manufacturers_slug as slug', 'manufacturers.manufacturer_name')
            ->where('manufacturers_info.languages_id', '=', Session::get('language_id'))
            //->where('manufacturers.manufacturers_status', 1)
...
///////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function products($data)
    {
		...
		if (!empty($data['author_id']) && $data['author_id'] != "") {
            $categories->where('products.products_author', '=', $data['author_id']);
        }
