                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="row">
										<input type="hidden" name="products_type" value="{{$result['product'][0]->products_type}}"/>
                                                ...
                                                <div class="tabbable tabs-left">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div style="margin-top: 15px;" class="tab-pane @if($j==0) active @endif" id="product_<?=$description_data['languages_id']?>">
															...
															<div class="form-group">
                                                                <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.ListofIngredients') }} ({{ $description_data['language_name'] }})</label>
                                                                <div class="col-sm-10 col-md-8">
                                                                    <textarea id="editor1<?=$description_data['languages_id']?>" name="products_listofingredients_<?=$description_data['languages_id']?>" class="form-control"
                                                                      rows="5">{{stripslashes($description_data['products_listofingredients'])}}</textarea>

                                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                                        {{ trans('labels.EnterProductDetailIn') }} {{ $description_data['language_name'] }}</span> </div>
                                                            </div>
															<div class="form-group">
                                                                <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Howtoprepare') }} ({{ $description_data['language_name'] }})</label>
                                                                <div class="col-sm-10 col-md-8">
                                                                    <textarea id="editor2<?=$description_data['languages_id']?>" name="products_howtoprepare_<?=$description_data['languages_id']?>" class="form-control"
                                                                      rows="5">{{stripslashes($description_data['products_howtoprepare'])}}</textarea>
