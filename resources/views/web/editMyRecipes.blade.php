                        ...
                        <div class="row mt-5">
                            <div class="col-md-9 mx-auto upload_recipe_Wrapper">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="products_name" name="products_name" value="{{$Products->products_name}}" required>
                                </div>
                                ...
                                <div class="form-row">
									...
									<div class="form-group col-md-3 mb-3 pl-lg-2">
                                        ...
                                        <input type="text" class="form-control" id="products_weight" name="products_weight" value="{{$Products->products_weight}}"required>
                                    </div>
                                    <div class="form-group col-md-3 mb-3 pl-lg-2">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="products_description" id="" class="form-control" cols="100%" rows="10" required> {{$Products->products_description}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="url" class="form-control" name="videourl" id="videourl" value="{{$Products->products_video_link}}" required>
                                    </div>
                                </div>
