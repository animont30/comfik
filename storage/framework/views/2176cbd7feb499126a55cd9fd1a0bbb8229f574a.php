                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        <?php echo Form::text('products_price', '0.0', array('class'=>'form-control number-validate', 'id'=>'products_price')); ?>
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div style="margin-top: 15px;" class="tab-pane <?php if($key==0): ?> active <?php endif; ?>" id="product_<?=$languages->languages_id?>">
                                                            <div class="">
																...
																<div class="form-group">
                                                                    <label for="name" class="col-sm-2 col-md-3 control-label"><?php echo e(trans('labels.ListofIngredients')); ?><span style="color:red;">*</span> (<?php echo e($languages->name); ?>)</label>
                                                                    <div class="col-sm-10 col-md-8">
																...
																<div class="form-group">
                                                                    <label for="name" class="col-sm-2 col-md-3 control-label"><?php echo e(trans('labels.Howtoprepare')); ?><span style="color:red;">*</span> (<?php echo e($languages->name); ?>)</label>
                                                                    <div class="col-sm-10 col-md-8">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GIT\comfik\resources\views/admin/products/add.blade.php ENDPATH**/ ?>