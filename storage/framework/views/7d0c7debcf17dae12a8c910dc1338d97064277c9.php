                            ...
                            <div class="col-md-9 mx-auto upload_recipe_Wrapper">
                                ...
                                <div class="form-row">
									...
									<div class="form-group col-md-3 mb-3 pl-lg-2">
                                        ...
                                        <input type="text" class="form-control" id="products_weight" name="products_weight">
                                    </div>
                                    <div class="form-group col-md-3 mb-3 pl-lg-2">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="products_howtoprepare" id="" class="form-control" cols="100%" rows="10"></textarea>
                                    </div>
                                </div>
