...
<main class="main-content">
                <div class="container-fluid px-md-5">
                    <form name="updateMyRecipe" class="align-items-center form-validate" action="<?php echo e(URL::to('updateMyRecipe')); ?>" method="post"enctype="multipart/form-data" > 
                            ...
                            <div class="col-md-9 mx-auto upload_recipe_Wrapper">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="select-category" name="food_type" required>
										...
										<option  value="<?php echo e($m->manufacturers_id); ?>"><?php echo e($m->manufacturer_name); ?></option>
                                    ...
                                    <div class="form-group col-md-6 pr-lg-4">
                                        ...
                                        <select class="form-control" id="select-category" name="serving_for" required>
                                           ...
                                           <?php $__currentLoopData = $result['categories']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<option  value="<?php echo e($m->categories_id); ?>"><?php echo e($m->categories_name); ?></option>
											<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
									<div class="form-group col-md-3 mb-3 pl-lg-2">
                                        <label for="products_weight">Recipes Weight</label>
                                        <input type="text" class="form-control" id="products_weight" name="products_weight" required>
                                    </div>
                                    <div class="form-group col-md-3 mb-3 pl-lg-2">
                                ...
                                <div class="form-row align-items-center want_to_sell_wrap mb-4">
                                    <div class="form-group col-md-2 decre-mt">
                                        <div class="custom-control pr-lg-4">
                                            ...
                                            <label class="switch">
                                                <input type="checkbox" name="products_sell">
                                    ...
                                    <div class="form-group col-md-7 recipe-sell-options decre-mt">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="6hour" name="products_deliver_time" class="custom-control-input" value="6 Hours">
                                            <label class="custom-control-label ml-3" for="6hour">6 Hours</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline ml-3">
                                            <input type="radio" id="8hour" name="products_deliver_time" class="custom-control-input" value="12 Hours">
                                            <label class="custom-control-label ml-3" for="12hour">12 Hours</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline ml-3">
                                            <input type="radio" id="12hour" name="products_deliver_time" class="custom-control-input" value="24 Hours">
                                    ...
                                    <div class="form-group col-md-3 recipe-sell-options">
                                        ...
                                        <input type="text" class="form-control" placeholder="₹" id="setprice" name="setprice" >
                                    </div>
                                </div>
                              ...
                              <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="description" id="" class="form-control" cols="100%" rows="10" required></textarea>
                                    </div>
                                </div>
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GIT\comfik\resources\views/web/uploadrecipes.blade.php ENDPATH**/ ?>