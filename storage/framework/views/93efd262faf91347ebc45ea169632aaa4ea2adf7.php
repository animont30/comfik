...
<main class="main-content">
                <div class="container-fluid px-md-5">
                    <form name="updateMyRecipe" class="align-items-center form-validate" enctype="multipart/form-data" action="<?php echo e(URL::to('updateMyRecipe')); ?>" method="post">
                        <div class="row mb-5">
                            <div class="col-12">
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/food/resources/views/web/uploadrecipes.blade.php ENDPATH**/ ?>