                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="author_pic ml-md-4">
                                <img src="<?php echo e(asset('./images/media/2021/08/user-2.jpg')); ?>" alt="Author Image">
                            </div>
                            <div class="author_social_handles mt-4 mb-2">
                                <ul class="d-flex align-items-center justify-content-center list-unstyled">
                                    <li class="social-item"><a href="#" class="social-link" title="Facebook"><img src="<?php echo e(asset('./images/media/2021/08/social/facebook.svg')); ?>" alt="Facebook"></a></li>
                                    <li class="social-item"><a href="#" class="social-link" title="Instagram"><img src="<?php echo e(asset('./images/media/2021/08/social/instagram.svg')); ?>" alt="Instagram"></a></li>
                                    <li class="social-item"><a href="#" class="social-link" title="Pinterest"><img src="<?php echo e(asset('./images/media/2021/08/social/pinterest.svg')); ?>" alt="Pinterest"></a></li>
                                    <li class="social-item"><a href="#" class="social-link" title="Twitter"><img src="<?php echo e(asset('./images/media/2021/08/social/twitter.svg')); ?>" alt="Twitter"></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-9">
                            <div class="author-name-contain d-flex flex-wrap align-items-center">
                                ...
                                <div class="contain-number ml-md-5 pl-md-3">+91 <?php echo e($result['author']->phone ?? ''); ?></div>
                                <div class="contain-email ml-md-5 pl-md-3"><?php echo e($result['author']->email ?? ''); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-11 mx-auto">
                    <div class="contain_author_cred_wrapper pb-5 mt-5 d-flex flex-wrap align-items-center justify-content-between">
                        <div class="cred_item d-flex flex-column pb-3 justify-content-center align-items-center">
                            <img src="<?php echo e(asset('./images/media/2021/08/author-recipe.png')); ?>" alt="Recipe icon">
                            <h3><?php echo e($result['products_total']); ?></h3>
                            <span>Uploaded Recipes</span>
                        </div>
                        <div class="cred_item d-flex flex-column pb-3 justify-content-center align-items-center">
                            <img src="<?php echo e(asset('./images/media/2021/08/heart-gray.png')); ?>" alt="Heart">
                            <h3><?php echo e($result['products_liked']); ?></h3>
                            <span>Likes</span>
                        </div>
                        <div class="cred_item d-flex flex-column pb-3 justify-content-center align-items-center">
                            <img src="<?php echo e(asset('./images/media/2021/08/comment-gray.png')); ?>" alt="Comments">
                            <h3><?php echo e($result['reviews']); ?></h3>
                            <span>Reviews</span>
                        </div>
                        <!--<div class="cred_item d-flex flex-column pb-3 justify-content-center align-items-center">
                            <img src="<?php echo e(asset('./images/media/2021/08/followers-gray.png')); ?>" alt="Followers">
                            <h3>87</h3>
                            <span>Followers</span>
                        </div>-->
                        <div class="cred_item d-flex flex-column pb-3 justify-content-center align-items-center">
                            <img src="<?php echo e(asset('./images/media/2021/08/order.png')); ?>" alt="Received Orders">
                            <h3><?php echo e($result['orders_total']); ?></h3>
                            <span>Received Orders</span>
                        </div>
                        <div class="cred_item d-flex flex-column pb-3 justify-content-center align-items-center">
                            <img src="<?php echo e(asset('./images/media/2021/08/earning.png')); ?>" alt="Total Earning">
                            <h3><?php echo e($result['total_earnings']); ?></h3>
                            <span>Total Earnings</span>
                        </div>
                        <!--<div class="cred_item d-flex flex-column pb-3 justify-content-center align-items-center">
                            <img src="<?php echo e(asset('./images/media/2021/08/followers-gray.png')); ?>" alt="Shared">
                            <h3>5642</h3>
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GIT\comfik\resources\views/web/dashboard.blade.php ENDPATH**/ ?>