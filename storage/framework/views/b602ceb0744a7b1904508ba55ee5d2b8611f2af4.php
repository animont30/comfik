...
<?php $__env->startSection('content'); ?>
                                            ...
                                            <?php $__currentLoopData = $result['description']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $description_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        <textarea id="editor_<?=$description_data['languages_id']?>" name="description_<?=$description_data['languages_id']?>" class="form-control"  rows="10" cols="80"><?php echo e(stripslashes($description_data['description'])); ?></textarea>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            CKEDITOR.replace('editor_<?php echo e($languages->languages_id); ?>').config.allowedContent = true;
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/food/resources/views/admin/pages/webpages/edit.blade.php ENDPATH**/ ?>