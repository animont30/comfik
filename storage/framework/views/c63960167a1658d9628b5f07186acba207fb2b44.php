								...
								<article class="article_wrapper pluto-post-box">
									<div class="post-body">
										...
										<div class="author-contain d-flex justify-content-between">
											<div class="author-social-wrap author-selfIn-list d-flex align-items-center justify-content-between">
												<div class="social-item text-center">
													<a class="btn btn-primary" style="width: 100%; " href="<?php echo e(URL::to('/editMyRecipe/'.$prod->products_id)); ?>">Edit Recipe</a>
												</div>
												<div class="social-item text-center">
													<a class="btn btn-danger" style="width: 100%;" href="<?php echo e(URL::to('/deleteMyRecipe/'.$prod->products_id)); ?>">Delete Recipe</a>
												</div>
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\food2\resources\views/web/myrecipes.blade.php ENDPATH**/ ?>