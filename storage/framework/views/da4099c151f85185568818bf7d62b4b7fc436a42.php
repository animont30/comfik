...
<!-- page Content -->
<section class="page-area pt-5 pb-4 changePasswordContain">
  <div class="container"> 
      <div class="row justify-content-center">
        ...
        <div class="col-12 col-sm-12 col-md-6">
          ...
          <div class="col-12 my-5">
             ...
             <h2><?php echo app('translator')->get('website.Change Password'); ?></h2>
                      ...
                      <form name="updateMyPassword" class="form-validate" id="updateMyPassword" enctype="multipart/form-data" action="<?php echo e(URL::to('/updateMyPassword')); ?>" method="post">
                        ...
                        <div class="alert alert-danger fade show" hidden id="passowrd-error" role="alert">
                          ...
                          <div class="col-12 col-sm-12">
                              <button type="submit" class="btn btn-secondary mt-3"><?php echo app('translator')->get('website.Update'); ?></button>                            
                          </div>
                      </form>
                      </div>
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/food/resources/views/web/changepassword.blade.php ENDPATH**/ ?>