...
<?php if(!empty($pagetitle)): ?>
	<title><?=stripslashes($pagetitle)?></title>
<?php else: ?>
...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('web/css/icomoon.css')); ?>"  />
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('web/css/custom.css')); ?>"  />
<script src="<?php echo asset('web/js/app.js'); ?>"></script>
<script src="<?php echo asset('web/js/custom.js'); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\GIT\comfik\resources\views/web/common/meta.blade.php ENDPATH**/ ?>